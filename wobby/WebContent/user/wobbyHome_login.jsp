...
<body class="pt-5">
	...
	<div class="container">
		...
		<header class="jumbotron my-4">
			...
			<h3>
				<b>${curUserId}</b>님, 어서오세요!
			</h3>
			<a href="user/myPage.jsp" class="btn btn-primary btn-lg">마이페이지</a> <a
				href="<c:url value='/club/myClub'/>" class="btn btn-primary btn-lg">내
				클럽 목록</a> <a href="<c:url value='/matching/page'/>"
				class="btn btn-primary btn-lg">매칭</a>
		</header>
	</div>
